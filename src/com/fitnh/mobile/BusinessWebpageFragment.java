...
public class BusinessWebpageFragment extends Fragment {
	private final String TAG = "FIT | BusinessWebpageFragment";
    ...
    public BusinessWebpageFragment() {
    ...
    private void createTitle(final Resources resources) { 
    	Log.v(TAG, "Creating action bar title for BusinessWebpageFragment");
        ...
        titleBuilder.append(" | ");
        titleBuilder.append(resources.getStringArray(R.array.drawer_business_child_titles)[fragmentIndex]);
	...
	private void setupWebView(final int fragmentIndex) {
        ...
        if(isNetworkConnected()) {
        	String webpage = getResources().getStringArray(R.array.business_page_urls)[fragmentIndex];
    ...
    private void cleanupFragment() {
    	Log.v(TAG, "Cleaning up after BusinessWebpageFragment");
