...
public class InvolvedWebpageFragment extends Fragment {
	private final String TAG = "FIT | InvolvedWebpageFragment";
    public final String ARG_WEBPAGE_NUMBER = "webpage_number";
    private final int mViewAnimationDuration = 2000;
    ...
    public InvolvedWebpageFragment() {
    ...
    private void createTitle(final Resources resources) { 
    	Log.v(TAG, "Creating action bar title for InvolvedWebpageFragment");
        ...
        if(useDesktopSite) {
        	titleBuilder.append(resources.getStringArray(R.array.drawer_involved_child_titles)[fragmentIndex]);
        } else {
        	titleBuilder.append(resources.getStringArray(R.array.drawer_involved_mobile_child_titles)[fragmentIndex]);
        }
	...
	private void setupWebView(final int fragmentIndex) {
        ...
        if(isNetworkConnected()) {
            ...
            String webpage = "";
            if(useDesktopSite) {
            	webpage = getResources().getStringArray(R.array.involved_page_urls)[fragmentIndex];
            } else {
            	webpage = getResources().getStringArray(R.array.involved_mobile_page_urls)[fragmentIndex];
            }
        	...
        	String webpage = getResources().getStringArray(R.array.involved_static_page_urls)[fragmentIndex];            	
        	mWebView.loadUrl(webpage);
        }
    }
    ...
    private void cleanupFragment() {
    	Log.v(TAG, "Cleaning up after InvolvedWebpageFragment");
